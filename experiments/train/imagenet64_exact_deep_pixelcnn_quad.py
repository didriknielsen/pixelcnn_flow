...
# Data
from pixelflow.data import CategoricalImageNet64
...
setup = CategoricalImageFlowSetup(supervised_dataloader=False)
...
for i in range(args.num_flows):
    ...
    transforms += [QuadraticSplineAutoregressiveSubsetTransform2d(PixelCNN(3,
...
model = AutoregressiveSubsetFlow2d(base_shape = (3,64,64,),
